...
custom_summary_data = read.csv2(args[1],sep=",",header=T,dec= '.')
DRAGEN_summary_data = read.csv2(args[2],sep=",",header=T,dec= '.')
DRAGEN_callable_summary_data = read.csv2(args[3],sep=",",header=T,dec= '.')
DRAGEN_X_summary_data = read.csv2(args[4],sep=",",header=T,dec= '.')
outdir=args[5]

giab_snp_all<-data.frame(categary=c('custom_TRUTH_TP',	'custom_TRUTH_FN',	'DRAGEN_TRUTH_TP',	'DRAGEN_TRUTH_FN',	'DRAGEN_callable_TRUTH_TP',	'DRAGEN_callable_TRUTH_FN', 'DRAGEN_X_TRUTH_TP',	'DRAGEN_X_TRUTH_FN','custom_TRUTH_TP',	'custom_QUERY_FP',	'DRAGEN_TRUTH_TP',	'DRAGEN_QUERY_FP',	'DRAGEN_callable_TRUTH_TP',	'DRAGEN_callable_QUERY_FP',	'DRAGEN_X_TRUTH_TP',	'DRAGEN_X_QUERY_FP'),number=c(custom_summary_data$TRUTH.TP[3],	custom_summary_data$TRUTH.FN[3],	DRAGEN_summary_data$TRUTH.TP[3],	DRAGEN_summary_data$TRUTH.FN[3],	DRAGEN_callable_summary_data$TRUTH.TP[3],	DRAGEN_callable_summary_data$TRUTH.FN[3], DRAGEN_X_summary_data$TRUTH.TP[3],	DRAGEN_X_summary_data$TRUTH.FN[3],custom_summary_data$TRUTH.TP[3],	custom_summary_data$QUERY.FP[3],	DRAGEN_summary_data$TRUTH.TP[3],	DRAGEN_summary_data$QUERY.FP[3],	DRAGEN_callable_summary_data$TRUTH.TP[3],	DRAGEN_callable_summary_data$QUERY.FP[3],	DRAGEN_X_summary_data$TRUTH.TP[3],	DRAGEN_X_summary_data$QUERY.FP[3]), comparison= c('TRUTH_custom', 'TRUTH_custom','TRUTH_DRAGEN', 'TRUTH_DRAGEN','TRUTH_DRAGEN_callable', 'TRUTH_DRAGEN_callable','TRUTH_DRAGEN_X', 'TRUTH_DRAGEN_X','QUERY_custom', 'QUERY_custom','QUERY_DRAGEN', 'QUERY_DRAGEN','QUERY_DRAGEN_callable', 'QUERY_DRAGEN_callable','QUERY_DRAGEN_X', 'QUERY_DRAGEN_X'), label_ypos=c(custom_summary_data$TRUTH.TP[3],	custom_summary_data$TRUTH.TP[3]+custom_summary_data$TRUTH.FN[3]+10000,	DRAGEN_summary_data$TRUTH.TP[3],	DRAGEN_summary_data$TRUTH.TP[3]+DRAGEN_summary_data$TRUTH.FN[3]+10000,	DRAGEN_callable_summary_data$TRUTH.TP[3],	DRAGEN_callable_summary_data$TRUTH.TP[3] +DRAGEN_callable_summary_data$TRUTH.FN[3]+10000, DRAGEN_X_summary_data$TRUTH.TP[3],	DRAGEN_X_summary_data$TRUTH.TP[3]+DRAGEN_X_summary_data$TRUTH.FN[3]+10000,custom_summary_data$TRUTH.TP[3],	custom_summary_data$TRUTH.TP[3]+custom_summary_data$QUERY.FP[3]+10000,	DRAGEN_summary_data$TRUTH.TP[3],	DRAGEN_summary_data$TRUTH.TP[3]+DRAGEN_summary_data$QUERY.FP[3]+10000,	DRAGEN_callable_summary_data$TRUTH.TP[3],	DRAGEN_callable_summary_data$TRUTH.TP[3]+DRAGEN_callable_summary_data$QUERY.FP[3]+10000, DRAGEN_X_summary_data$TRUTH.TP[3],	DRAGEN_X_summary_data$TRUTH.TP[3]+DRAGEN_X_summary_data$QUERY.FP[3]+10000))
giab_snp_all$comparison <- factor(giab_snp_all$comparison,levels = c('TRUTH_custom', 'TRUTH_DRAGEN', 'TRUTH_DRAGEN_callable','TRUTH_DRAGEN_X','QUERY_custom','QUERY_DRAGEN','QUERY_DRAGEN_callable','QUERY_DRAGEN_X'))
pdf(paste0(outdir,'/','giab_custom_DRAGEN_callable_snp_all.pdf'),width=7.5,height=4.5)
ggplot(data=giab_snp_all, aes(x=comparison, y=number, fill=factor(categary, levels= c('custom_TRUTH_FN','custom_QUERY_FP','custom_TRUTH_TP','DRAGEN_TRUTH_FN','DRAGEN_QUERY_FP','DRAGEN_TRUTH_TP','DRAGEN_callable_TRUTH_FN','DRAGEN_callable_QUERY_FP','DRAGEN_callable_TRUTH_TP','DRAGEN_X_TRUTH_FN','DRAGEN_X_QUERY_FP','DRAGEN_X_TRUTH_TP'))))+
